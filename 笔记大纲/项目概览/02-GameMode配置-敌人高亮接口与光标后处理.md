...
- [UE5 学习笔记 — 第三次提交](#section-1)
  - [目录](#section-2)
  - [一、GameMode 游戏模式配置](#section-3)
    - [1.1 为什么需要 GameMode？](#section-4)
    - [1.2 C++ 基类创建](#section-5)
    - [1.3 蓝图配置流程](#section-6)
  - [二、角色移动系统 + 动画修复](#section-7)
    - [2.1 弹簧臂与相机（蓝图添加）](#section-8)
    - [2.2 AuraCharacter C++ 构造函数](#section-9)
    - [2.3 动画蓝图修复：空闲 / 跑步状态分离](#section-10)
  - [三、Custom Depth 自定义深度配置](#section-11)
    - [3.1 启用 Custom Depth-Stencil Pass](#section-12)
    - [3.2 自定义深度宏定义](#section-13)
  - [四、敌人高光标记系统（核心）](#section-14)
    - [4.1 为什么用接口而不是直接 Cast？](#section-15)
    - [4.2 EnemyInterface 接口定义](#section-16)
    - [4.3 AAuraEnemy 实现接口](#section-17)
  - [五、鼠标光标追踪系统](#section-18)
    - [5.1 PlayerTick 每帧追踪](#section-19)
    - [5.2 CursorTrace 核心逻辑](#section-20)
    - [5.3 五状态机详解](#section-21)
  - [六、后处理高亮效果配置](#section-22)
    - [6.1 后处理体积（Post Process Volume）](#section-23)
    - [6.2 PP\_Highlight 材质工作原理](#section-24)
    - [6.3 完整高亮流程](#section-25)
  - [七、新增 / 修改文件清单](#section-26)
  - [八、知识点总结](#section-27)
...
- 使用哪个玩家控制器类(BP_AuraPlayerController)
- 使用哪个默认 Pawn 类(BP_AuraCharacter)
